...
int initialization()
{
	...
	int getaddrinfo_return = getaddrinfo( "::1", "24022", &internet_address_setup, &internet_address_result );
...
void execution( int internet_socket )
{
	...
	number_of_bytes_send = send( internet_socket, "Hoi TCP server, ik ben de client", 32, 0 );
